...
class Campus
{
    ...
    #[Assert\NotBlank(message: 'Le nom du campus ne peut être vide.')]
    #[Assert\Length(
        min: 1,
        max: 100,
        minMessage: 'Le nom du campus doit avoir au minimum 1 caractère.',
        maxMessage: 'Le nom du campus ne peut dépasser 100 caractères.'
    )]
